...
let numeroIngresado = readlineSync.question("ingrese un numero ");// se pide al usuario que ingrese un numero que se guarda en la variable numeroIngresado
let numeroNuevo : number = Number(numeroIngresado);// se convierte la cadena numero ingresado en un numero (number) y el numero convertido se guarda en la variable numeroNuevo
